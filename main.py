...
try:
    ...
    print("Model not found or corrupted. Retraining...")
...
def home():
    ...
    if not valid_symptoms:
        return render_template('index.html', message="⚠ No valid symptoms recognized. Please check spelling.")

    predicted_disease = get_predicted_value(valid_symptoms)
    desc, pre, med, diet, wrk = helper(predicted_disease)
    precautions_list = pre[0] if pre else []
